...
export const PERSONAL_KPI_META: Record<PersonalKpiKey, { label: string; format: "currency" | "count" | "percent" | "rank"; explain: string }> = {
  ...
  pendingPremium: { label: "Pending Premium", format: "currency", explain: "Annual premium currently sitting in Pending status." },
  issuedPremium: { label: "Issued Premium", format: "currency", explain: "Lifetime annual premium currently marked Issued." },
  canceledPremium: { label: "Canceled Premium", format: "currency", explain: "Lifetime annual premium currently marked Canceled." },
  policiesSubmitted: { label: "Policies Submitted", format: "count", explain: "Policies submitted this calendar month." },
  activePolicies: { label: "Active Policies", format: "count", explain: "Policies not Canceled, Lapsed, Declined, or Chargeback." },
